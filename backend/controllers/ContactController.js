...
module.exports = {
  async getAll(req, res) {
    try {
      ...
      const { rows, count } = await Contact.findAndCountAll(findOptions);
  ...
  async getOne(req, res) {
    try {
      ...
      const data = await Contact.findByPk(req.params.id, opts);
  ...
  async update(req, res) {
    try {
      ...
      await Contact.update(body, { where: { id: req.params.id } });
